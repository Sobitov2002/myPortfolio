            ...
            <div
                ...
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        Passionate Developer & Technical Engineer
                        Building modern web applications with Vue.js, TypeScript & Tailwind CSS.
                        Experienced in automation, system optimization, and cloud technologies.
                        Skilled in Linux systems and technical support.
                    </p>
                ...
                <div class="lg:h-full md:flex">
                    <div
                        ...
                        <div
                            ...
                            <img src="https://ik.imagekit.io/vtroph5l9/Product/my%20Image/banner.jpg?updatedAt=1741417487511"
                                alt="Hero pic" width="500" height="auto" loading="lazy"
