    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                I am a passionate developer & technical engineer with
                    experience in building modern web applications using Vue.js, TypeScript, and Tailwind CSS. I have a
                    strong background in automation, system optimization, and cloud technologies.

                    Additionally, I am skilled in Linux systems, Python scripting, and technical support, ensuring
                    smooth operations and solving complex technical challenges. Always eager to learn and innovate, I
                    thrive in dynamic environments that push me to grow.
                </p>
